# https://raw.githubusercontent.com/openai/roboschool/master/agent_zoo/RoboschoolWalker2d_v1_2017jul.py
...
class ZooPolicyTensorflow(object):
    def __init__(self, name, ob_space, ac_space, take_weights_here=None):
        ...
        with tf.variable_scope(name):
            ...
            dense1_w = tf.get_variable("dense1_w", [22,128])
            ...
            x = tf.nn.relu(x)
            final_w = tf.get_variable("final_w", [64,6])
            final_b = tf.get_variable("final_b", [6])
